...
class Parser(object):
    ...
    def __init__(self):
        ...
        parser.add_argument("--hparams",default='',help="Comma separated list of name=value hyperparameter pairs")
        ...
        # parser.add_argument("--dropout", default=0.2, help="Dropout Probab. for Pre-Final Layer", type=float)
        # parser.add_argument("--max_epochs", default=100, help="Maximum Number of Epochs", type=int)
        # parser.add_argument("--patience", default=6, help="Patience", type=int)
